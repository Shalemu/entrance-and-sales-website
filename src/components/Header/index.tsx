...
const formattedDate = useMemo(() => {
  ...
  <div className="flex items-center w-full">
    ...
    <div className="flex items-center gap-3 px-5 py-2 bg-gray-1 border border-gray-3 rounded-l-[0px]">
    ...
    {/* Right side (DATE FIELD - expanded) */}
    <div
      onClick={() => inputRef.current?.showPicker?.()}
      className="flex-1 relative bg-gray-1 border border-gray-3 border-l-0 rounded-r-[0px] px-5 py-2 cursor-pointer"
    >

      {/* Text */}
      <p className={`text-sm ${
        selectedDate ? "text-dark font-medium" : "text-gray-400"
      }`}>
        {selectedDate ? formattedDate : "Select booking date"}
      </p>
  ...
  <ul className="flex items-center gap-3">
    ...
    <li>
      <Link
        ...
        target="_blank"
        className="flex items-center justify-center w-7 h-7 rounded-full border border-gray-300 text-gray-700 hover:bg-pink-100 hover:text-pink-600 transition"
      >
        <FaInstagram size={13} />
      </Link>
    </li>
    ...
    <li>
      <Link
        ...
        target="_blank"
        className="flex items-center justify-center w-7 h-7 rounded-full border border-gray-300 text-gray-700 hover:bg-blue-100 hover:text-blue-600 transition"
      >
        <FaFacebookF size={12} />
      </Link>
    </li>
    ...
    <li>
      <Link
        ...
        target="_blank"
        className="flex items-center justify-center w-7 h-7 rounded-full border border-gray-300 text-gray-700 hover:bg-sky-100 hover:text-sky-700 transition"
      >
    ...
    <li>
      <Link
        ...
        target="_blank"
        className="flex items-center justify-center w-7 h-7 rounded-full border border-gray-300 text-gray-700 hover:bg-gray-200 hover:text-black transition"
      >
        <FaTiktok size={12} />
      </Link>
    </li>
